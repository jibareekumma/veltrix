...
const handleGoogleCredential = async function (credential) {
  setError("");
  try {
    ...
    <section className="register">
      <div className="register__panel">
        <div className="register__content">
          ...
          <p className="register__subtitle">Join VELTRIX and step into performance</p>
          ...
          <div className="register__social">
            <div className="register__social-btn-wrapper">
